  ...
  componentDidMount() {
    ...
    if (typeof window !== 'undefined')
      window.onresize = () => {
        ...
        if (!this.refContainer.current || !this.refContainer.current.scrollWidth || !this.refContainer.current.scrollHeight) return;
        this.graph.changeSize(this.refContainer.current.scrollWidth, this.refContainer.current.scrollHeight);
      };
